...
class Testcase(unittest.TestCase):
    ...
    def test_case(self):
        driver = self.driver
        driver.get(self.base_url + "/san-jose")
        driver.find_element_by_id("header-sign-up").click()
        driver.find_element_by_id("first_name").clear()
        driver.find_element_by_id("first_name").send_keys("name")
        driver.find_element_by_id("last_name").clear()
        driver.find_element_by_id("last_name").send_keys("surname")
        ...
        self.assertRegexpMatches(driver.find_element_by_css_selector("BODY").text, r"^[\s\S]* [\s\S]*$")
